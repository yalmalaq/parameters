...
int main(int argc, char *argv[]) {
    if (argc < 11) {
        fprintf(stderr, "Usage: %s queue1_size queue2_size queue3_size queue4_size queue5_size queue6_size queue7_size queue8_size queue9_size queue10_size queue11_size\n", argv[0]);
        return 1;
    }
